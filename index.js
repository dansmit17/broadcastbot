...
var customCMDs=require(__dirname+"/lib/customCMDs.js").spark;
...
bot.customCMDs=new customCMDs({token:process.env.SPARK_TOKEN, me:process.env.BOT_EMAIL});
...
controller.setupWebserver(process.env.PORT || 3000, function (err, webserver) {
    ...
    webserver.get('/files', function(req, res){
        console.log("******************");
        res.send(req);
    })
